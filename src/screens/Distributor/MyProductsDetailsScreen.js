...
export default function MyProductsDetailsScreen({route,navigation}) {
    ...
    return (
        ...
        <View style={{alignItems:'center'}}>
            ...
            <View>
                ...
                <Text style={styles.text1}>Price Per Carton: PKR {data.pricePerCarton}</Text>
                <Text style={styles.text1}>PurchasePrice Distributor: PKR {data.purchasePriceDistributor}</Text>
                <Text style={styles.text1}>SalePrice Distributor: PKR {data.salePriceDistributor}</Text>
