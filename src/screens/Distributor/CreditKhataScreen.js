...
import { vPaymentVD } from '../../global/Distributor/VendorPaymentData';
import { sPaymentSD } from '../../global/Distributor/ShopKeeperPaymentData';
...
export default function CreditKhataScreen({navigation}) {
    ...
    const [data,setData]=useState(vPaymentVD)

    return (
        <View style={styles.container}>
            <Header navigate={navigation} title='Distributor' />
            <View style={styles.textBarTab}>
                <Text style={styles.textTop}> Khata Management  </Text>
            </View>
            ...
            <FlatList
              ...
              renderItem={({item})=>(
                <View style={{marginRight:10}}>
                    <CreditInfoCard item={item} userType='distributor' navigate={()=>navigation.navigate('CreditKhataHistoryScreen',{data:item})} />
                </View>
              )}
            />
        </View>
