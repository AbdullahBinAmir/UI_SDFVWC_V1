...
export default function VendorProductsDetails({route,navigation}) {
    ...
    return (
        ...
        <View style={styles.titleBar}>
            <Text style={styles.titleBarText}>Vendor Products Details</Text>
        </View>
        ...
        <View style={{alignItems:'center'}}>
            ...
            <View>
                ...
                <Text style={styles.text1}>Price Per Carton: {data.pricePerCarton}</Text>
                <Text style={styles.text1}>PurchasePrice Distributor: {data.purchasePriceDistributor}</Text>
                <Text style={styles.text1}>SalePrice Distributor: {data.salePriceDistributor}</Text>
                <Text style={styles.text1}>Number of Carton: {data.no_Of_Carton}</Text>
                <Text style={styles.text1}>Threshold To Buy: {data.thresholdToBuy}</Text>
